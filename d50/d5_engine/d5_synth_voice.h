...
public:
    void note_on(const SynthSpec& spec, float note, float velocity,
        ...
        // 03.09.2026 and left every D-50 partial 26 units -- more than an
        ...
        // base gave -57 (upstream PR #145, part 2 of issue #142).
    ...
    void block_mod(const Modulation& mod) {
        ...
        // Until 03.09.2026 panel 1..50 were all squares here (upstream PR
        // #145, part of issue #142).
