...
- Микросхема пресетов IC15 менялась с `LH5310-97` на `LH5310-DJ` ради «improvement on ROM
  play data», и **с DJ требуется прошивка не ниже 1.07**. В нашем наборе ПЗУ лежит
  `r15179873-lh5310-97.ic12.bin`, то есть более ранний вариант данных демо, вместе с
  прошивкой 1.10 - сочетание, которое ограничение не запрещает (оно односторонее), но знать
  о нём стоит: демо-песни у нас с «-97».
