...
Страницы 1 и 2 (байты 22 и 34, то есть смещения +8 и +20 внутри партиала) не сдвинули ни
одного регистра. Толковать это пока нельзя: может, параметр и вправду не доходит до
микросхемы при этой структуре, а может, доходит не сразу. Отдельный опыт не ставился.
