...
| `Part+` | сдвинувшиеся байты тембра |
| --- | --- |
| 1 | 14, 22, 34, 37, 42, 55, 61 |
| 2 | 72, 80, 92, 95, 100, 113 |

Смещения внутри партиала совпадают в точности: `14→+0`, `22→+8`, `34→+20`, `37→+23`,
`42→+28`, `55→+41` и `72→+0`, `80→+8`, `92→+20`, `95→+23`, `100→+28`, `113→+41`. Разница баз
72 − 14 = **58 байт на партиал**, ровно как в структуре тембра D-110 (10 байт имени, 4 байта
общей части, дальше четыре партиала по 58). `Group+` листает параметры внутри выбранного
партиала.
